...
| ![히스토리](images/히스토리.jpg) | ![히스토리 상세](images/히스토리상세.jpg) |
| :----------------------------------------------------: | :------------------------------------------------: |
|                  히스토리                   |                       히스토리 상세                       |

## 캠페인

| ![캠페인](images/캠페인.jpg) | ![캠페인 상세](images/캠페인상세.jpg) |
| :----------------------------------------------------: | :------------------------------------------------: |
|                  캠페인                   |                       캠페인 상세                       |

## 펫

| ![펫 선택](frontend/public/common/챌린지_조회_댓글.gif) | ![펫 획득](frontend/public/common/챌린지_WebRTC.gif) | ![펫 획득](frontend/public/common/챌린지_WebRTC.gif) |
| :----------------------------------------------------: | :------------------------------------------------: |
|                  펫 선택                   |                       펫 획득                       |
