...
def predict():
   if request.method == 'POST':
      ...
      # AWS S3 클라이언트 설정
      s3 = boto3.client('s3', aws_access_key_id='AKIA2UC27RTFNQDD7ICX', aws_secret_access_key='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')
      ...
      class_name, class_idx = classify_garbage(image_path)
      print("종류: " + class_name)
      print("인덱스: ", class_idx)
